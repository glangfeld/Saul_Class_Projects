...
/**
 * Created by glang on 2/21/2017.
 */
public class dl4J_NN_1Q_ahead_classifier1 {

    private static Logger log = LoggerFactory.getLogger(dl4J_NN_1Q_ahead_classifier1.class);
    ...
    public static void main(String[] args) throws  Exception {
        ...
        recordReader.initialize(new FileSplit(new File("/Users/glang/OneDrive/Documents/Tulane/Senior Year First Semester/Capstone/Saul_Class_Projects/data/garrett_langfeld/Data_for_NN_1Q_Ahead_2.csv")));
