...
public class CompanyDataReader
{
    ...
    public CompanyDataReader() throws IOException{
        ...
        BufferedReader br = new BufferedReader(new FileReader("/Users/glang/OneDrive/Documents/Tulane/Senior Year First Semester/Capstone/Saul_Class_Projects/data/garrett_langfeld/Initial_Data_With_Sector_Market_Cap2.csv"));
        String line="";
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (line.substring(0,7).equals("Company") || line.substring(0,7).equals(",,,,,,,")){
                ...
                if (row.length > 0){
                    ...
                    float MC = Float.parseFloat(row[20]);
                    String sector = row[21];

                    companyData comp = new companyData(name,quarter,rating, endDate, ND_EBITDA, TD_EBIT, ND_EBIT, EBITDA_Interest, EBITDA_Cap_Int, EBIT_Int, int_exp, CE_TA, LT_DE, LT_DC, LT_DTA, TDE, TDC, TDA, num_rating, rating_change, MC, sector);
                    compData.add(comp);
                }
